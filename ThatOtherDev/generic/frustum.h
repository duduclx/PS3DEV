...
void NormalizePlane(float frustum[6][4], int side){
	int A = 0;				// The X value of the plane's normal
	int B = 1;				// The Y value of the plane's normal
	int C = 2;				// The Z value of the plane's normal
	int D = 3;				// The distance the plane is from the origin
...
void CFrustum::CalculateFrustum(){
	...
	int RIGHT	= 0;		// The RIGHT side of the frustum
	int LEFT	= 1;		// The LEFT	 side of the frustum
	int BOTTOM	= 2;		// The BOTTOM side of the frustum
	int TOP		= 3;		// The TOP side of the frustum
	int BACK	= 4;		// The BACK	side of the frustum
	int FRONT	= 5;		// The FRONT side of the frustum
